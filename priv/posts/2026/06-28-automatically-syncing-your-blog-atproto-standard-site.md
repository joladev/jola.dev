...
Although atproto was created by Bluesky to drive their social network, the protocol itself is actually provider agnostic and there are already lots of alternative apps, like [mu.social](http://mu.social) by Eurosky, and [you can migrate your data across data servers (PDSs)](https://move.eurosky.tech/)! Lots of services are popping up that use atproto to provide you with functionality, while letting you own your data.
